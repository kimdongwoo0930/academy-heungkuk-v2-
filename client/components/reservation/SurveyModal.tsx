                      ...
                      {a ? (
                        <>
                          <div className={styles.infoGrid}>
                            {a.location && <span className={styles.infoTag}><b>위치</b> {a.location === '기타' ? a.locationEtc : a.location}</span>}
                            {a.industry && <span className={styles.infoTag}><b>업태</b> {a.industry === '기타' ? a.industryEtc : a.industry}</span>}
                            {a.purpose && <span className={styles.infoTag}><b>목적</b> {a.purpose === '기타' ? a.purposeEtc : a.purpose}</span>}
                            {a.visitRoute && <span className={styles.infoTag}><b>계기</b> {a.visitRoute === '기타' ? a.visitRouteEtc : a.visitRoute}</span>}
                          </div>
                            ...
                            {SATISFACTION_ITEMS.map(({ key, label, commentKey }) => {
                              ...
                              return (
                                <div key={String(key)} className={styles.ratingRow}>
                                  ...
                                  {comment && <span className={styles.ratingComment}>{comment}</span>}
                                </div>
                              );
                            })}
                          </div>
                          {a.revisit && (
                            <div className={styles.comment}>
                              ...
                              <p className={styles.commentText}>{REVISIT_LABELS[a.revisit] ?? a.revisit}</p>
                            </div>
                          )}
                          {a.comment && (
                            <div className={styles.comment}>
