...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
        ...
        @Query(value = "SELECT COUNT(*) FROM reservation WHERE reservation_code LIKE CONCAT(:prefix, '%')",
                        nativeQuery = true)
        ...
        List<Reservation> findByYear(@Param("startOfYear") LocalDate startOfYear,
